...
def execute(filters=None):
	...
	company_currency = frappe.db.get_value("Company", company_list[0], "default_currency")
	...
	for cash_flow_account in cash_flow_accounts:
		...
		for account in cash_flow_account['account_types']:
			account_data = get_account_type_based_data(company_list[0], account['account_type'], period_list)
			account_data.update({
